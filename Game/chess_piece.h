...
public:
	...
	virtual vector<pair<short, short> > AvailableMoves(PieceColor boardC[8][8], PieceType boardT[8][8]) {
		...
		if (moves == 0 && ((movingDirection == 1 && rowPosition == 1) || (movingDirection == -1 && rowPosition == 6)) && boardC[rowPosition + movingDirection][columnPosition] == Blank && boardC[rowPosition + (2 * movingDirection)][columnPosition] == Blank)
